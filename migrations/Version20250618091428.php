 ...
 */
final class Version20250618091428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE "Match" ADD COLUMN set_par_equipe INTEGER DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__Match AS SELECT id, equipe1_id, equipe2_id, poule_id, terrain_id, date_match, heur_debut, match_en_cours, score1, score2, valide FROM "Match"
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE "Match"
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO "Match" (id, equipe1_id, equipe2_id, poule_id, terrain_id, date_match, heur_debut, match_en_cours, score1, score2, valide) SELECT id, equipe1_id, equipe2_id, poule_id, terrain_id, date_match, heur_debut, match_en_cours, score1, score2, valide FROM __temp__Match
        SQL);
        $this->addSql(<<<'SQL'
