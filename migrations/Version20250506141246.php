 ...
 */
final class Version20250506141246 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE "Match" ADD COLUMN heur_fin TIME NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE "Match" ADD COLUMN durée_pause INTEGER NOT NULL
        SQL);
    }
}
