 ...
 */
final class Version20250514132516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__Match AS SELECT id, equipe1_id, equipe2_id, poule_id, date_match, heur_debut, match_en_cours, score1, score2, valide FROM "Match"
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE "Match"
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE "Match" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, equipe1_id INTEGER NOT NULL, equipe2_id INTEGER NOT NULL, poule_id INTEGER NOT NULL, terrain_id INTEGER DEFAULT NULL, date_match DATE DEFAULT NULL, heur_debut TIME DEFAULT NULL, match_en_cours BOOLEAN NOT NULL, score1 INTEGER NOT NULL, score2 INTEGER NOT NULL, valide BOOLEAN DEFAULT NULL, CONSTRAINT FK_BB9AEA014265900C FOREIGN KEY (equipe1_id) REFERENCES equipe (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BB9AEA0150D03FE2 FOREIGN KEY (equipe2_id) REFERENCES equipe (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BB9AEA0126596FD8 FOREIGN KEY (poule_id) REFERENCES poule (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BB9AEA018A2D8B41 FOREIGN KEY (terrain_id) REFERENCES Terrain (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO "Match" (id, equipe1_id, equipe2_id, poule_id, date_match, heur_debut, match_en_cours, score1, score2, valide) SELECT id, equipe1_id, equipe2_id, poule_id, date_match, heur_debut, match_en_cours, score1, score2, valide FROM __temp__Match
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__Terrain AS SELECT id, occupé, longueur, largeur FROM Terrain
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE Terrain
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO Terrain (id, occupé, longueur, largeur) SELECT id, occupé, longueur, largeur FROM __temp__Terrain
        SQL);
        $this->addSql(<<<'SQL'
